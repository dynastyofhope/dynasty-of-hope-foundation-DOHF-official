...
const DOH_CONFIG = {
  ...
  siteUrl: "https://dynastyofhope.github.io/dynasty-of-hope-foundation-DOHF-official/",
  registerUrl: "https://dynastyofhope.github.io/dynasty-of-hope-foundation-DOHF-official/register.html",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll("form[data-store]").forEach(form => {
    form.addEventListener("submit", e => {
      ...
      const rec = DOH_Store.add(form.getAttribute("data-store"), data);
